                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            @include('notice.succes')
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data"
                                      id="commentForm" method="post" action="{{ route('permission.store') }}">
                                    {{ csrf_field() }}
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">权限标识</label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-2">权限名称</label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <label for="curl" class="control-label col-lg-2">权限描述</label>
                                        <div class="col-lg-10">
